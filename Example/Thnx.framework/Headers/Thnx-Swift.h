...
SWIFT_CLASS("_TtC4Thnx18ThnxViewController")
@interface ThnxViewController : UIViewController
@property (nonatomic, copy) NSDictionary<NSString *, NSString *> * _Nonnull licenses;
@property (nonatomic, strong) UITableView * _Nonnull tableView;
@property (nonatomic, copy) NSArray<NSString *> * _Null_unspecified urls;
@property (nonatomic, strong) UIFont * _Nullable sectionHeaderFont;
@property (nonatomic, strong) UIColor * _Nullable sectionHeaderBackgroundColor;
@property (nonatomic, strong) UIColor * _Nullable sectionHeaderTextColor;
@property (nonatomic, strong) UIColor * _Nullable contentViewBackgroundColor;
@property (nonatomic, strong) UIFont * _Nullable textLabelFont;
...
@property (nonatomic) CGColorRef _Nullable textLabelLayerBorderColor;
/**
  ...
  \param urls Array of strings that are urls to the repositories you want to get licenses too.

*/
- (nonnull instancetype)initWithUrls:(NSArray<NSString *> * _Nonnull)urls OBJC_DESIGNATED_INITIALIZER;
/**
...
@interface ThnxViewController (SWIFT_EXTENSION(Thnx))
/**
...
@interface ThnxViewController (SWIFT_EXTENSION(Thnx)) <UITableViewDelegate, UIScrollViewDelegate>
/**
...
@interface ThnxViewController (SWIFT_EXTENSION(Thnx)) <UITableViewDataSource>
/**
